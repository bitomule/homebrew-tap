class KoubouCanary < Formula
  ...
  def install
    ...
    bin.install_symlink libexec/"bin/kou" => "kou-canary"
  end

  test do
    system "#{bin}/kou-canary", "--version"
  end
end
